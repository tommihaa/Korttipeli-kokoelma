...
Jokaiselle jaetaan 5 käsikorttia. Valtti määräytyy pakan pohjimmaisesta kortista (näkyvissä pakan alle). Pata ei voi olla valtti — satuessa uusi yritys.

Tavoite: pääste kortit käsistä ensimmäisenä.
...
### Puolustajan vuoro
1. Puolustaja **kaataa** jokaisen kortin saman maan suuremmalla kortilla **tai** valttimalla
2. Jos puolustaja ei kaada kaikkia → **nostaa kaatamatta jääneet käteensä** ja vuoro siirtyy
3. Jos kaikki kartit kaadetaan → kaatanut täydentää kätensä ja **hyökkää seuraavalla vuorolla**

### Spesiaalit säännöt
- **Patakuningatar (Maija)** — ei kelpaa kaatokortiksi, vaan **on aina nostettava** käteen
- Täysin onnistuneesta kaadosta → kaatanut saa jatkaa hyökkäyksenä
...
4. **Patakuningatar (Maija) jää viimeisenä** — "jutussa istuu Maija"

## Pelaajien näkyvyys

- Jokainen pelaaja näkee **oman kätensä** koko ajan
- Pöydän kortit ovat **näkyvät kaikille** (hyökkäys- ja puolustuskortti)
- Muiden pelaajien kätensä koko on **näkyvä** mutta kortit **piilossa**
...
2. Priorisoituu matalan arvon kortit hyökkäykselle
...
Maija on **hyökkäys/puolustus-peli** jossa strategia ja pelilukutaito ratkaisevat. Maija-kortin poistaminen pelistä luo dramaattisen hetken — viimeinen pelaaja, joka joutuu nostamaan sen, häviää.
