...
const GAMES = [
  ...
  },
  {
    ...
    rules: [
      ...
      'Sekvenssi 7→6→8 avaa maan siilo (6→A) ja torni (8→K)',
...
const SANASTO = [
  ...
  { kategoria: 'alue',   term: 'Torni',         match: ['torni','tornit','tornin','torniin','torneja'],                    emoji: '🗼', selitys: 'Nouseva korttijono: 8→9→10→J→Q→K. Rakentuu 7:stä ylöspäin kun 8 on pelattuna. K kaataa tornin.',                                                                         pelit: ['ristiseiska']                  },
  { kategoria: 'alue',   term: 'Siilo',         match: ['siilo','siilon','siiloon','siiloja','siilot'],                     emoji: '🏗', selitys: 'Laskeva korttijono: 6→5→4→3→2→A. Täyttyy ylhäältä alas kun 6 on pelattuna. A kaataa siilon.',                                                                           pelit: ['ristiseiska']                  },
