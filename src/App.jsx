...
const SANASTO = [
  ...
  { kategoria: 'alue',   term: 'Yläpino',       match: ['yläpino','yläpinot','yläpinon','yläpinoon'],                      emoji: '⬆️', selitys: 'Nouseva pino: 8→9→10→J→Q→K. Avautuu kun maan sekvenssi 7→6→8 on pelattu. K sulkee yläpinon.',                                                                        pelit: ['ristiseiska']                  },
  { kategoria: 'alue',   term: 'Alapino',       match: ['alapino','alapinot','alapinon','alapinoon'],                       emoji: '⬇️', selitys: 'Laskeva pino: 6→5→4→3→2→A. Avautuu kun maan sekvenssi 7→6→8 on pelattu. A sulkee alapinon.',                                                                         pelit: ['ristiseiska']                  },
