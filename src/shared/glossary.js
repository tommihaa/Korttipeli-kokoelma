...
export const SANASTO = [
  ...
  { kategoria: 'kortti', term: 'Rakennelma',   match: ['rakennelma*'], emoji: '🔨', selitys: 'Valitset pöydältä kortteja ja lisäät oman käsikorttisi: niiden summa on rakennelman arvo. Sinulla täytyy olla kädessäsi toinen kortti samalla arvolla, jolla kaappaat rakennelman myöhemmin. Vastustaja voi varastaa rakennelman jos hänellä on saman arvoinen kortti.', pelit: ['kasino'] },
  ...
  { kategoria: 'kortti', term: 'Täsmäys',      match: ['täsmäys','täsmäyksen'],                                  emoji: '👐', selitys: 'Kasan kaksi päällimmäistä korttia ovat samaa arvoa. Nopein läpsääjä voittaa koko kasan. Väärä läpsäys sen sijaan lisää kortin kasaan.',                             pelit: ['lapsy']                        },
...
export function splitWithGlossary(text, entries = SANASTO) {
  ...
  // Tyhjä termistö: ilman tätä regexista tulisi `()`, joka osuu nollan mittaisena
  // eikä kuluta tekstiä — silmukka jäisi ikuiseksi. Sisarkopio Itussa (terms.ts).
