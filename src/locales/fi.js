...
export const fi = {
  ui: {
    ...
    menu: { back: '← Valikko', settings: 'Asetukset', info: 'Info', share: 'Jaa Jako⁹', recommended: 'Suosittu peli', startHere: 'Uusi peleissä? Kokeile ensin ★-merkittyjä suosikkeja.' },
    ...
    rules: { label: 'Säännöt', moreTerms: 'Lisää termejä: Sanasto' },
    turn: {
      yours: 'Sinun vuorosi:',
      kultakala: 'nosta kortti pakasta tai poistopakasta',
      koputus: 'nosta kortti pakasta tai poistopakasta',
      lapsy: 'käännä kortti keskelle',
      seiska: 'lyö kortti tai nosta pakasta',
      ristiseiska: 'lyö sallittu kortti tai passaa',
      paskahousu: 'lyö kortti, tai nosta jos et voi',
      kasino: 'kaappaa, rakenna tai jätä kortti',
      maijaAttack: 'lyö saman maan kortteja',
      maijaDefend: 'kaada kortit tai nosta ne',
      moskaAttack: 'lyö saman vahvuisia kortteja',
      moskaDefend: 'kaada kortit tai nosta ne',
    },
    ...
    settings: {
      ...
      preset: {
        ...
        beginnerDesc: 'täysi opastus näkyvillä',
        experienced: 'Kokenut',
        experiencedDesc: 'vähemmän opasteita',
        custom: 'Mukautettu: olet säätänyt asetuksia itse.',
      },
    ...
    infoPanel: {
      ...
      esittelyParas: [
        'Hei Hero!',
        'Seurapelit ovat hauskoja, varsinkin korttipelit yhdessä. 52 kortin pakka ei paljoa maksa ja kulkee mukana.',
        ...
        'Minua kiinnostaisi tietää, kuka tätä käyttää, mutta halusin pitää kynnyksen matalana. Jos haluat, kerro silti kokemuksestasi palautteen kautta.',
  ...
  games: {
    kultakala: {
      ...
      msg: {
        ...
        humanDrawDiscard: 'Nostit {card} ({v} p) poistopakasta. Vaihto on pakollinen, klikkaa kenttäkorttia.',
        humanDrawDeck: 'Nostit {card} ({v} p). Vaihda se kenttäkorttiin tai Heitä poistopakkaan.',
      ...
      rules: [
        'Kenttäsi: 6 korttia piilossa. 5 opit vaihtamalla, 1 tuntematon paljastuu vasta pistelaskussa',
    ...
    lapsy: {
      ...
      msg: {
        ...
        respondedSpecialNoRival: '{player} vastasi {card}! Ei enää vastustajia, joten kasa on hänen!',
        ...
        challengedNoRival: '{player} haastaa {card}! Ei enää vastustajia, joten kasa on hänen!',
        ...
        correctSlap: '{player} läpsäsi nopeiten{ms} ja voitti {count} korttia!',
      ...
      rules: [
        ...
        'Kasaan käännetty kuvakortti on haaste: seuraavalla pelaajalla on 1–4 korttia aikaa kääntää pinostaan oma kuvakortti ja siirtää haaste eteenpäin',
        'Viimeinen, jolla on kortteja, voittaa',
      ],
    },
    ristiseiska: {
      ...
      msg: {
        ...
        aiBonus: '{name}: Kaatoi {suit} {pile} ja voi jatkaa!',
        ...
        passGiveRandom: '{name} passaa ja vetää korttipantiksi satunnaisen kortin ({card}) pelaajan {giverName} viuhkasta.',
        passOnly: '{name} passaa.',
        badCard: 'Tämä kortti ei käy tähän, valitse toinen.',
        cantPass: 'Sinulla on pelattavissa oleva kortti, joten passata ei voi.',
      ...
      pile: { lower: 'alapinon', upper: 'yläpinon' },
      ui: {
      ...
      rules: [
        ...
        'Jos mikään korttisi ei käy → korttipantti: edellinen pelaaja, jolla on yli yksi kortti, antaa sinulle kädestään vaikeasti pelattavan kortin',
    ...
    seiska: {
      ...
      msg: {
        ...
        reshuffle: 'Pakka loppui. Lyöntipakka sekoitettiin uudeksi pakaksi.',
      ...
      rules: [
        ...
        '1 kortti jäljellä → sano LAPPU heti, muuten saat 3 lisäkorttia',
        'Ensin korteitta → voittaa',
        'Viimeisenä kortteja kädessä → häviää',
      ],
    },
    kasino: {
      ...
      rules: [
        'Kaappaus: valitse pöydältä kortteja, joiden summa täsmää käsikorttisi arvoon',
        'Tai jätä kortti pöytään, jolloin muut voivat käyttää sitä omien käsikorttiensa summiin',
      ...
      ui: {
        ...
        captureHelpA: ': paina nappia, valitse pöytäkortit, joiden summa täsmää käsikorttisi arvoon, ja klikkaa sitten käsikorttia. ',
        mokkiWord: 'Mökki',
        ...
        buildHelp: ': paina nappia ja valitse pöytäkortteja, joiden summa + käsikorttisi = rakennelman arvo. Sinulla täytyy olla kädessä toinen samanarvoinen kortti kaappaukseen. Vastustaja voi kähveltää rakennelmasi.',
      },
    },
    koputus: {
      ...
      msg: {
        ...
        queenMsg: 'Kuningatar! Valitse ensin oma kortti, jonka haluat vaihtaa…',
        ...
        aiKnock: '{name} koputtaa ja luottaa käteensä!',
        aiReact: '{name} reagoi lyömällä {card}. Kortti poistuu!',
        aiWrongReact: '{name} reagoi väärällä kortilla! Rangaistus.',
        botBattleStart: '🤖 Bottien taistelu alkaa!',
        ...
        lastCardPlayed: 'Löit viimeisen korttisi, peli päättyy sinulle! Erinomaista!',
      ...
      rules: [
        'Alussa kurkkaat kaksi omaa korttiasi. Paina ne mieleesi. Muut opit pelin aikana tai vaihdat pakasta nostettuun.',
        'Kun kenttäkorttisi täsmää poistopakan päällimmäiseen → lyö se poistopakkaan ennen muita',
        'Koputus käynnistää viimeisen kierroksen',
        'Pienin pistemäärä paljastuksessa voittaa',
      ],
    },
    maija: {
      desc: 'Osittainen kaato: torjuntavoitto. Täyskaato: hyökkäät seuraavaksi.',
      msg: {
    ...
    paskahousu: {
      ...
      msg: {
        ...
        blindSwept: '{name} veti sokkona {card} pakasta ja kaatoi {count} kortin kasan! Jatkaa.',
      ...
      ui: {
        ...
        hintPlay: 'Pelaa klikkaamalla korttia. Voit valita useita samanarvoisia. Kortin on oltava yhtä suuri tai suurempi kuin päällimmäinen.',
      ...
      rules: [
        'Lyö kasaan samaa tai suurempaa arvoa, vaikka useamman samanarvoisen kerralla',
        '2♠ / 2♣ = kova kakkonen: käy minkä tahansa kortin päälle paitsi kaatokortin',
        '10 tai A kaataa kasan · myös neljä samaa kaataa. Kaadettu kasa poistuu pelistä',
        'Ensin korteitta → voittaa',
        'Viimeisenä kortteja kädessä → häviää',
      ],
    },
    moska: {
      ...
      msg: {
        ...
        canAdd: '{name}: Voit lyödä sivusta: {cards}, tai paina Ohita.',
      ...
      ui: {
        ...
        pairs: ({ n }) => n === 1 ? '1 pari' : `${n} paria`,
        beaten: '✓ {n} kaadettu',
        unbeaten: '! {n} lyömättä',
        hintAttack: 'Valitse samanarvoiset hyökkäyskortit ja klikkaa Hyökkää.',
        hintPass: ({ cards }) => `Siirto: ${cards}. Klikkaa Siirrä tai peruuta.`,
        hintDefendCanPass: 'Valitse ensin pöytäkortti, jonka haluat kaataa, tai siirrä hyökkäys eteenpäin klikkaamalla samanarvoista korttiasi.',
      ...
      rules: [
        'Hyökkääjä lyö kortteja. Puolustaja joko siirtää hyökkäyksen samanarvoisella, kaataa kaikki tai nostaa kaikki',
  ...
  glossary: {
    ...
    sanastoIntro: 'Napauta termiä, niin selitys aukeaa alle. Korostetut termit aukeavat myös pelivalikon säännöistä.',
