...
export const CHANGELOG = [
  ...
  },
  {
    ...
    items: [
      ...
      'Kasinon korttienemmistö on nyt 3 pisteen arvoinen entisen yhden sijaan, eli kierroksesta jaetaan 11 pistettä tikkien lisäksi. Muutos palauttaa vakiosäännöt: kortteja kannattaa kerätä myös silloin kun ne eivät ole pistekortteja, ja korttienemmistöstä tulee tavallisin yksittäinen syy voittaa kierros. Muut pisteet ovat ennallaan (♦10 kaksi, ♠2 yksi, kukin ässä yksi, patojen enemmistö yksi).',
      ...
      'Moskan botit siirtävät hyökkäyksen eteenpäin nyt samoilla säännöillä kuin sinä. Aiemmin botilla oli kaksi ylimääräistä rajoitusta: se ei siirtänyt kuin rajatun määrän kertoja peräkkäin, eikä se koskaan siirtänyt valttikortilla. Kumpikaan rajoitus ei koskenut ihmispelaajaa, joten sama tilanne salli sinulta siirron mutta esti botilta. Nyt sääntö on yksi ja sama, ja botit säästävät valttia vain silloin kun muutakin kelpaavaa korttia on. Samalla korjautui Mestarin neuvo, joka saattoi vaieta siirrosta joka oli sinulle sallittu.',
      'Kultakalan Mestari ottaa poistopakan pikkukortin herkemmin pelin kahdella viimeisellä kierroksella. Syy on se, ettei tuntemattomaksi jäänyttä paikkaa ehdi enää korjata: loppusuoralla kannattaa tyytyä pienempäänkin parannukseen. Oppipoika ja Kisälli pelaavat kuten ennenkin. Mittasimme muutoksen 400 pelin sarjoilla, eikä se muuttanut voimasuhteita, joten kyse on pelityylin johdonmukaisuudesta eikä vahvistuksesta.',
